...
INSERT INTO artist
VALUES (gen_random_uuid(), (SELECT DISTINCT id FROM custom_user WHERE username = 'lxr4k'), 'drain shawty', DEFAULT);

INSERT INTO song
VALUES (gen_random_uuid(), (SELECT DISTINCT id FROM genre WHERE name = 'hyperpop'), 'void in my heart', DEFAULT);
INSERT INTO song
VALUES (gen_random_uuid(), (SELECT DISTINCT id FROM genre WHERE name = 'hyperpop'), 'где я', DEFAULT);
